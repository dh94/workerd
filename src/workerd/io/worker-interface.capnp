...
struct Trace @0x8e8d911203762d34 {
  ...
  struct Onset {
    ...
    info :union {
      ...
      scheduled @4 :ScheduledEventInfo;
      alarm @5 :AlarmEventInfo;
      queue @6 :QueueEventInfo;
      email @7 :EmailEventInfo;
      trace @8 :TraceEventInfo;
      hibernatableWebSocket @9 :HibernatableWebSocketEventInfo;
      custom @10 :CustomEventInfo;
    }
  }
